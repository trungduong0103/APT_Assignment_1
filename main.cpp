...
void extract_data_from_column(int array[], const string &file_name, Column column);
...
int main() {
    ...
    extract_data_from_column(x_column_array, file_name, Column::x);
    extract_data_from_column(y_column_array, file_name, Column::y);
}
